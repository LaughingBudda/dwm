...
static const char *mutecmd[] = { "changeVolume", "-q", "set", "Master", "toggle", NULL };
static const char *volupcmd[] = { "changeVolume", "-q", "set", "Master", "5%+", "unmute", NULL };
static const char *voldowncmd[] = { "changeVolume", "-q", "set", "Master", "5%-", "unmute", NULL };
...
static const Layout layouts[] = {
	...
	{ "[MonCl]",      monocle },
	{ "[CenMs]",      centeredmaster },
	{ "[CnFMs]",      centeredfloatingmaster },
 	{ "[Spirl]",      spiral },
 	{ "[Dwndl]",     dwindle },
};
